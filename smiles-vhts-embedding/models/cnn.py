...
def create_model(input_shape, output_size, max_index):
    input_layer = Input(shape=input_shape, name='input')
    l = Embedding(max_index + 1, 100, input_length=input_shape[0], name='embedding')(input_layer)
    l = Dropout(0.2, name='dropout_input')(l)
