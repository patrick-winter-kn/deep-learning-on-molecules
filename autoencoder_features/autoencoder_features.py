...
trainer.train(model_file, matrices_h5['smiles_matrix'], 50, 1, 292)
# generate features
features_file = prefix + '-features.h5'
predictor.encode(model_file, matrices_h5['smiles_matrix'], 292, features_file)
features_h5 = h5py.File(features_file, 'r')
