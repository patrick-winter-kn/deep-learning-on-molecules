...
def create_model(input_shape, output_size):
    ...
    l = Convolution1D(2, 2, activation='relu', name='convolution_1')(l)
    l = MaxPooling1D(2, name='pooling_1')(l)
    l = Dropout(0.2, name='dropout_pooling_1')(l)
    l = Convolution1D(8, 8, activation='relu', name='convolution_2')(l)
    l = MaxPooling1D(2, name='pooling_2')(l)
    l = Dropout(0.2, name='dropout_pooling_2')(l)
    l = Convolution1D(20, 20, activation='relu', name='convolution_3')(l)
    l = MaxPooling1D(2, name='pooling_3')(l)
    l = Dropout(0.2, name='dropout_pooling_3')(l)
